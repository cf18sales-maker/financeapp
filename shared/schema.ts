import { pgTable, text, varchar, numeric, boolean, integer, timestamp, pgEnum } from "drizzle-orm/pg-core";
import { createInsertSchema } from "drizzle-zod";
import { z } from "zod";
import { sql } from "drizzle-orm";

export const accountTypeEnum = pgEnum("account_type", ["checking", "savings", "credit_card", "investment", "loan", "other"]);
...
export const ruleOperatorEnum = pgEnum("rule_operator", ["contains", "starts_with", "ends_with", "equals", "regex", "gt", "lt", "gte", "lte"]);
